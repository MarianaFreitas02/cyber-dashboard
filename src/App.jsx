...
// Import dos componentes e páginas
...
// Componente Header (só funciona dentro do Router)
const Header = () => {
...
function App() {
  ...
  // 2. Se estiver logado, mostra o Sistema (Router)
  return (
    <Router>
